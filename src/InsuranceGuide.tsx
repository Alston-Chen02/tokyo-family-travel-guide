...
const shared = [
  ...
  ['旅行文件損失／班機改降', '分別定額 3,000 元／5,000 元。'],
...
export default function InsuranceGuide() {
  return <section className="insurance-guide" aria-labelledby="insurance-title">
    ...
    <footer className="insurance-caption">整理依據：本次要保書、金平安 PRO 6 方案表（2026/5）、理賠文件表（2026/7）及理賠提醒。此處為出遊速查摘要，承保範圍、除外責任與理賠仍依正式保單及條款。海外救援電話已於 2026/09/15 核對南山產物官方服務資訊。</footer>
  </section>;
}
