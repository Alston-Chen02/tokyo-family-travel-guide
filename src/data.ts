...
export const RESERVATION_HUB = [
  ...
  },
  {
    ...
    meta: '09/23 · 需官方 App',
    status: '確認票種',
    note: '三種票型權益不同；入園後立即用 App 申請商店、Playhouse 與表演限定入場。',
    url: 'https://www.pokepark-kanto.co.jp/ppark/ticketInfo/type/index?languageKind=en_US',
    action: '票種與 App',
  },
];
...
export const DAYS: DayPlan[] = [
  ...
  },
  {
    ...
    cityKey: 'urayasu',
    stops: [
      mkStop('d2s1', '07:30', '酒店早餐', '補充體力迎接夢幻日',
        '於酒店享用早餐，提前開啟 Disney App、確認所有門票已加入同一群組，並整理 DPA、Entry Request、Standby Pass 與行動點餐順序。40 週年 Priority Pass 已於 2026/08/31 結束。',
        ['Disney App 與門票群組', 'DPA / Entry Request', 'Standby Pass', '檢查雨衣與行動電源'],
        { type: 'walk', label: '步行', route: '酒店餐廳', duration: '—' },
        'Tokyo Bay Maihama Hotel', 'urayasu', '早餐:酒店自助', '已含於住宿費'),
      mkStop('d2s2', '08:15 抵達排隊／09:00 開園', '東京迪士尼樂園', '官方營業時間 09:00–21:00；當日仍須再確認',
        '08:15 抵達安檢與排隊，官方目前公告 09:00 開園。入園後先處理「美女與野獸城堡奇緣」Disney Premier Access，再依當日 App 狀況安排 Entry Request、Standby Pass 與行動點餐。',
        ['美女與野獸城堡奇緣', '巨雷山', '太空山', '迪士尼遊行'],
        { type: 'walk', label: '步行 / 接駁', route: '酒店 → 迪士尼', duration: '15 分' },
        'Tokyo Disneyland', 'urayasu', '午餐:園內主題餐', '門票 ¥9,400/人',
        'https://www.tokyodisneyresort.jp/tdl/',
        [
          { icon: 'heart', text: '育嬰室 (Baby Center) 位置：怪物電力公司旁 & 夢幻樂園內，可泡奶、溫牛奶、換尿布。' },
          { icon: 'phone', text: '入園第一件事：開啟 Disney App 掃描門票，並抽/購 DPA（優先順序：美女與野獸 ➔ 巨雷山）。' },
        ]),
      mkStop('d2s3', '13:00', '園區午餐與遊行', '東側廣場夢幻遊行',
        '於世界市集側享用午餐,下午 13:30 觀賞「迪士尼眾彩交融」遊行。隨後體驗小熊維尼獵蜜記、幽靈公館等親子設施。',
        ['世界市集午餐', '眾彩交融遊行', '小熊維尼獵蜜記', '幽靈公館'],
        { type: 'walk', label: '園內步行', route: '園區內移動', duration: '—' },
        'Tokyo Disneyland World Bazaar', 'urayasu', '午餐:吉拿棒甜點', '預算依個人消費'),
      mkStop('d2s4', '19:30 - 21:00', '夜間電子大巡遊與城堡夜景', '美國濱海/城堡前廣場',
        '19:35 欣賞「東京夢光」夜間電子大巡遊（夢幻電子花車）。觀賞完畢後享受迪士尼城堡夜間燈光氛圍，把握最後時間購買迪士尼紀念品與搭乘最後遊樂設施。迪士尼當日閉園時間為 21:00。',
        ['「東京夢光」夜間電子大巡遊', '城堡夜間燈光氛圍', '紀念品最後採購', '最後遊樂設施'],
        { type: 'walk', label: '園內步行', route: '園區內移動', duration: '—' },
        'Tokyo Disneyland Night Parade', 'urayasu', '晚餐:園內輕食', '預算依個人消費'),
      mkStop('d2s5', '21:15', '返回飯店 / 享受東京灣希爾頓設施', '東京灣希爾頓飯店 (Hilton Tokyo Bay)',
        '從迪士尼樂園門口搭乘迪士尼度假區線（或希爾頓免費接駁巴士 Resort Cruiser）約 5-10 分鐘返回東京灣希爾頓飯店。晚間可至飯店內 24 小時便利商店（FamilyMart）購買宵夜甜點，或於房間享受迪士尼海景/園區夜景，好好休息準備明日行程。',
        ['免費接駁車 / 單軌電車', '希爾頓24H便利商店', '室內泳池與休憩', '迪士尼海景/園區夜景'],
  ...
  },
  {
    ...
    dateLabel: '09/23',
    weekday: '三',
    theme: '寶可夢樂園 • 阿卡將戰利品採買',
    cityLabel: '東京・多摩 ➔ 錦糸町（銀座為選配）',
    cityKey: 'kinshicho',
    stops: [
      mkStop('d5s1', '08:30 - 09:00', '退房 & 行李託運 (巨蛋 ➔ 錦糸町)', '東京巨蛋飯店 ➔ 錦糸町樂天城市酒店',
        '於東京巨蛋飯店辦理退房，將大行李交付櫃檯當日直寄至【錦糸町樂天城市酒店】，輕裝展開寶可夢樂園與採買行程。',
        ['退房 & 行李託運', '輕裝出發', '行李直寄錦糸町'],
        { type: 'walk', label: '館內', route: '飯店櫃檯', duration: '—' },
        'Tokyo Dome Hotel', 'tokyo', '—', '行李託運服務'),
      mkStop('d5s2', '09:00 - 10:00', '移動交通：巨蛋 ➔ 讀賣樂園', 'JR中央·總武線 + 京王線特急 • 約 50 分',
        '由水道橋站搭乘【JR 中央·總武線】至新宿站，轉乘【京王線特急】至京王讀賣樂園站，再搭乘空中纜車或公車至園區。',
        ['JR 中央·總武線', '京王線特急', '空中纜車 / 公車', '約 50 分'],
        { type: 'train', label: 'JR + 京王線', route: '水道橋 → 新宿 → 京王讀賣樂園', duration: '約 50 分' },
        'Keio Yomiuriland Station', 'kinshicho', '—', 'IC 卡車資 ¥720 / 人'),
      mkStop('d5s3', '10:00 - 13:30', 'PokéPark KANTO (寶可夢樂園草紗鎮)', '讀賣樂園 (Yomiuriland) 內',
        'PokéPark 提供 Ace Trainer’s Pass、Trainer’s Pass、Town Pass 三種票型，權益與可進入區域不同。通過讀賣樂園入口後，立即用官方 App 申請 Pokémon Daisuki Shop、Pokémon Playhouse 與 Sedge Gym Show 的限定入場；兩項遊樂設施則在草紗鎮行動售票機另購。',
        ['先確認三種票型', '入園即申請限定入場', '官方 App 顯示票券', '皮卡丘／伊布遊樂設施另購'],
        { type: 'walk', label: '園區', route: '園區入口 → PokéPark KANTO', duration: '—' },
        'PokéPark KANTO Yomiuriland', 'kinshicho', '午餐:園內主題餐', '門票 + 餐飲 ¥3,500~¥5,000 / 人',
        'https://pokepark.jp/'),
      mkStop('d5s4', '13:30 - 14:40', '移動交通：讀賣樂園 ➔ 錦糸町', '京王線 + JR 中央・總武線',
        '主線直接返回錦糸町：搭京王線至新宿，再轉 JR 中央・總武線。9/23 為日本國定假日，帶孩子不把銀座塞進轉乘途中；若全家體力仍充足，再於傍晚把銀座列為選配。',
        ['京王線', 'JR 中央・總武線', '連假預留候車時間', '銀座改為選配'],
        { type: 'train', label: '京王線 + JR', route: '京王讀賣樂園 → 新宿 → 錦糸町', duration: '約 55-70 分' },
        'Lotte City Hotel Kinshicho', 'kinshicho', '—', 'IC 卡車資依當日路線'),
      mkStop('d5s5', '14:30 - 16:30', '入住錦糸町樂天城市酒店 • 小孩午睡充電', '錦糸町樂天城市酒店 (Lotte City Hotel Kinshicho)',
        '自讀賣樂園返回錦糸町，先前往飯店辦理 Check-in 入住。大行李箱已由 Airporter 直寄送達房內。讓孩子在寬敞的套房內好好午睡休息補足體力，大人也可稍作休息整頓。',
        ['塔樓小型套房', '飯店Check-in', '親子午休充電', '行李已送達房內'],
        { type: 'walk', label: '步行', route: '錦糸町站 → 樂天城市酒店', duration: '3 分' },
        'Lotte City Hotel Kinshicho', 'kinshicho', '—', '免費參觀'),
      mkStop('d5s6', '16:30 - 18:00', '錦糸町阿卡將集中採買（銀座 UNIQLO 選配）', 'Arcakit 錦糸町 5F · 飯店正對面',
        '主線留在飯店正對面的錦糸町阿卡將，集中採買嬰幼兒用品、零食與藥妝。只有孩子休息充足、園區離場順利時，才另外前往銀座 UNIQLO；若去銀座，阿卡將與藥妝至少擇一，不安排來回折返全制霸。',
        ['阿卡將婦幼用品', '免稅直購', '銀座僅選配', '避免連假折返'],
        { type: 'walk', label: '步行', route: '飯店 → Arcakit 錦糸町', duration: '3 分' },
        'Akachan Hompo Kinshicho', 'kinshicho', '下午茶:商場輕食', '採買預算 ¥10,000~¥30,000 / 人',
        'https://www.akachan.jp/'),
      mkStop('d5s6b', '18:00 - 19:00', '大國藥妝 (Daikoku Drug) 錦糸町北口店', '錦糸町站北口 (飯店步行 3 分鐘)',
        '位於樂天城市酒店斜對面的大國藥妝，價格親民且品項齊全。現場提供免稅服務（Tax-Free），適合集中一次補齊合利他命、胃藥、貼布、面膜等人氣藥妝與各式平價日系零食。',
        ['免稅購物', '人氣藥妝補貨', '平價日本零食', '合利他命EX', 'EVE止痛藥', 'ROIHI鎮痛貼布', '免稅優惠'],
        { type: 'walk', label: '步行', route: '飯店 → 大國藥妝錦糸町北口店', duration: '3 分' },
        'Daikoku Drug Kinshicho North Exit', 'kinshicho', '—', '採買預算 ¥5,000~¥15,000 / 人',
        'https://maps.google.com/?q=Daikoku+Drug+Kinshicho+North+Exit'),
      mkStop('d5s7', '19:00 - 21:00', '晚餐 & 整理戰利品', '錦糸町 OIOI 百貨 / Arcakit 美食街',
        '於錦糸町 OIOI 百貨或 Arcakit 美食街內享用日式晚餐，回到套房內輕鬆攤開所有大行李箱，優雅整理戰利品與打包準備明日返台。',
        ['晚餐：日式晚餐', '打包戰利品', 'OIOI 百貨', 'Arcakit 美食街'],
        { type: 'walk', label: '步行', route: '阿卡將 → OIOI / Arcakit', duration: '3 分' },
        'OIOI Kinshicho', 'kinshicho', '晚餐：日式晚餐', '餐飲預算約 ¥2,000~¥4,000 / 人',
