...
export const RESERVATION_HUB = [
  ...
  },
  {
    ...
    meta: '09/23 · 品川站高輪口步行約 2 分',
    status: '待購票',
    note: '成人入館 ¥2,800，3 歲以下免費。水豚餵食目前因健康管理暫停；若恢復，使用日前 7 天 00:00 開放預約，每場 8 人，3 歲以下不可餵食。',
  ...
  },
  {
    ...
    stops: [
      ...
      mkStop('d5s3', '09:40 - 10:10', '入場・確認水豚與表演場次', 'Maxell Aqua Park 品川（品川王子大飯店內）',
        '使用預先購買的入場券進館，先看當日館內活動表，確認水豚展示、餵食活動是否恢復及海豚表演時間。9/23 的完整場次尚未公布，不先鎖定未確認時刻。',
        ['預先購票', '確認當日活動表', '水豚活動狀態', '海豚表演時刻'],
        { type: 'walk', label: '館內步行', route: '入口 → 2F Aqua Jungle', duration: '約 20-30 分' },
        'Maxell Aqua Park Shinagawa', 'tokyo', '—', '成人 ¥2,800 / 人；3 歲以下免費',
