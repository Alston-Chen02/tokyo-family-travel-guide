...
export const DAYS: DayPlan[] = [
  {
    ...
    stops: [
      ...
      mkStop('d1s2', '13:39 - 14:18', '搭乘京成電鐵 Skyliner 32號 (前往日暮里/押上)', '成田機場 ➔ 市區 37 分鐘直達',
        'Skyliner 32 號 13:39 成田機場第 1 航廈發車 / 13:42 第 2·3 航廈發車，14:18 抵達日暮里站（轉乘地鐵前往押上/晴空塔）。出關後至 B1 售票機或櫃檯憑 KKday QR Code 兌換實體劃位車票。搭乘高速特快 37 分鐘直達市區。',
        ['Skyliner 劃位', 'Suica 西瓜卡', 'B1 售票機兌換'],
        { type: 'train', label: '京成 Skyliner 32號', route: '成田機場 → 日暮里 → 押上', duration: '37 分' },
  ...
  },
  {
    ...
    stops: [
      mkStop('d2s1', '07:30', '酒店早餐', '補充體力迎接夢幻日',
        '於酒店享用豐盛早餐,提前整理好迪士尼 APP 入場券與排隊策略。',
        ['日式洋式自助餐', '整理 FastPass 策略', '檢查裝備雨衣'],
        { type: 'walk', label: '步行', route: '酒店餐廳', duration: '—' },
        'Tokyo Bay Maihama Hotel', 'urayasu', '早餐:酒店自助', '已含於住宿費'),
      mkStop('d2s2', '08:15', '東京迪士尼陸地開園', '夢幻開始',
        '提早 30 分鐘抵達排隊。開園後直衝「美女與野獸城堡奇緣」,再依序攻略巨雷山、太空山。善用 Disney Premier Access 降低排隊時間。',
  ...
  },
  {
    ...
    stops: [
      ...
      mkStop('d3s3', '11:00 - 12:30', '大宮鐵道博物館', '日本最大鐵道主題館',
        ...
        'Railway Museum Saitama', 'omiya', '—', '門票 ¥1,500/人',
  ...
  },
  {
    ...
    stops: [
      ...
      mkStop('d5s3', '10:00 - 13:30', 'PokéPark KANTO (寶可夢樂園草紗鎮)', '讀賣樂園 (Yomiuriland) 內',
        '體驗皮卡丘飛天椅、伊布旋轉木馬，欣賞寶可夢嘉年華巡遊與主題周邊店，親子沉浸在寶可夢草紗鎮的夢幻世界。',
        ['皮卡丘飛天椅', '伊布旋轉木馬', '寶可夢嘉年華巡遊', '主題周邊店'],
        { type: 'walk', label: '園區', route: '園區入口 → PokéPark KANTO', duration: '—' },
        'PokéPark KANTO Yomiuriland', 'kinshicho', '午餐:園內主題餐', '門票 + 餐飲 ¥3,500~¥5,000 / 人',
        'https://pokepark.jp/'),
      mkStop('d5s4', '13:30 - 14:30', '移動交通：讀賣樂園 ➔ 銀座 / 錦糸町', '京王線 + 丸之內線 / JR總武線',
        '搭乘【京王線】返回新宿站，轉乘【地鐵丸之內線】至銀座採買，或搭乘【JR 總武線】直達錦糸町站，動線靈活銜接下午戰利品採購。',
        ['京王線', '地鐵丸之內線', 'JR 總武線', '銀座 / 錦糸町靈活銜接'],
        { type: 'train', label: '京王 + 地鐵/JR', route: '京王讀賣樂園 → 新宿 → 銀座/錦糸町', duration: '約 40-50 分' },
        'Ginza Station', 'kinshicho', '—', 'IC 卡車資 ¥600~¥820 / 人'),
      ...
      mkStop('d5s6', '16:30 - 18:00', '一站式戰利品日 (銀座UNIQLO ➔ 錦糸町阿卡將)', 'UNIQLO 銀座旗艦店 & 錦糸町阿卡將 (Akachan Honpo)',
        '小朋友睡飽充飽電後出門採買！可先搭地鐵前往 UNIQLO 銀座旗艦店，或直接在飯店正對面的【錦糸町阿卡將婦幼旗艦店】（Arcakit 錦糸町 5F）集中採買嬰幼兒用品、零食與藥妝。',
        ['UNIQLO旗艦店', '阿卡將婦幼用品', '免稅直購', '嬰幼兒零食與藥妝'],
        { type: 'walk', label: '步行/地鐵', route: '飯店 → 銀座 / 阿卡將', duration: '—' },
